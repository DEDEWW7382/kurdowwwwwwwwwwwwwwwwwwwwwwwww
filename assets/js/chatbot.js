...
(function() {
  ...
  function customReply(intent, input) {
    if (intent === 'creator') return "J'ai été codé par Dersim pour pouvoir vous aider en répondant à vos questions sur les Kurdes, leur histoire, leur culture et leurs langues.";
